package ar.vicria.tourbot.tourpoint.microservice.services.basic;

import ar.vicria.tourbot.tourpoint.dto.basic.BaseDto;
import ar.vicria.tourbot.tourpoint.microservice.entities.BaseEntity;
...
public abstract class BaseMappedService<ENTITY extends BaseEntity,
    ...
    public DTO updateEntity(ENTITY entity, DTO dto) {
        return mapper.updateEntity(entity, dto);
    }
    ...
    public DTO update(ID id, DTO dto) {
        ...
        DTO dto1 = updateEntity(readEntity, dto);
