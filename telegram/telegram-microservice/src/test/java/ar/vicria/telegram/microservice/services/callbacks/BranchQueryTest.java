...
public class BranchQueryTest {
    ...
    public void getLines() {
        ...
        expectedLines.add("линия1");
        expectedLines.add("линия2");
        expectedLines.add("линия3");
        assertEquals(expectedLines, branchQuery.getLines());
    }
    ...
    @ParameterizedTest
    @CsvSource(value = {
            "RoutMessage   |   Выберите направление                       |  1  |  2",
